            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/main.GetAddressMrc20BarResult"
                        }
                    },
                    "400": {
                        "description": "Error message if retrieval fails",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/main.GetAddressMrc20ListResult"
                        }
                    },
                    "400": {
                        "description": "Error message if retrieval fails",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/main.GetAddressMrc721BarResult"
                        }
                    },
                    "501": {
                        "description": "Error message if retrieval fails",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/main.GetAddressMrc721BarPlusResult"
                        }
                    },
                    "400": {
                        "description": "Error message if retrieval fails",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/main.GetAddressMrc721HoldersResult"
                        }
                    },
                    "400": {
                        "description": "Error message if retrieval fails",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/main.GetBurnInfoResult"
                        }
                    },
                    "400": {
                        "description": "Error message if retrieval fails",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/main.GetGenesisDataResult"
                        }
                    },
                    "400": {
                        "description": "Error message if retrieval fails",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/main.OrdHookEvent"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/main.GetInscriptionResult"
                        }
                    },
                    "400": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/main.GetLotteryListResult"
                        }
                    },
                    "400": {
                        "description": "Error message if retrieval fails",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/main.GetMrc721CollectionsResult"
                        }
                    },
                    "501": {
                        "description": "Error message if retrieval fails",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/main.WebMrcAllInscriptionResult"
                        }
                    },
                    "400": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/main.ScanMissingBlocksResult"
                        }
                    },
                    "400": {
                        "description": "Error message if retrieval fails",
    ...
    "definitions": {
        ...
        "main.GetAddressMrc20BarResult": {
            ...
            "properties": {
                ...
                "data": {
                    "$ref": "#/definitions/main.GetAddressMrc20BarData"
                },
                "message": {
                    "type": "string"
                }
        ...
        "main.GetAddressMrc20ListResult": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "integer"
                ...
                "data": {
                    "$ref": "#/definitions/main.GetAddressMrc20ListData"
                },
                "message": {
                    "type": "string"
                }
        ...
        "main.GetAddressMrc721BarPlusData": {
            "type": "object",
            "properties": {
                "bars": {
                    "type": "array",
        ...
        "main.GetAddressMrc721BarPlusResult": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "integer"
                ...
                "data": {
                    "$ref": "#/definitions/main.GetAddressMrc721BarPlusData"
                },
                "message": {
                    "type": "string"
                }
        ...
        "main.GetAddressMrc721BarResult": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "integer"
        ...
        "main.GetAddressMrc721HoldersData": {
            "type": "object",
            "properties": {
                "all_count": {
                    "type": "integer"
        ...
        "main.GetAddressMrc721HoldersResult": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "integer"
                ...
                "data": {
                    "$ref": "#/definitions/main.GetAddressMrc721HoldersData"
                },
                "message": {
                    "type": "string"
                }
        ...
        "main.GetLotteryListResult": {
            ...
            "properties": {
                ...
                "data": {
                    "$ref": "#/definitions/main.GetLotteryListData"
                },
                "message": {
                    "type": "string"
                }
        ...
        "main.GetMrc721CollectionsResult": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "integer"
        ...
        "main.OrdHookBlock": {
            ...
            "properties": {
                "block_identifier": {
                    "$ref": "#/definitions/main.OrdHookBlockIdentifier"
                },
                "metadata": {
                    "type": "object",
                    "additionalProperties": true
                ...
                "transactions": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/main.OrdHookTransaction"
                    }
                }
            }
        },
        "main.OrdHookBlockIdentifier": {
            "type": "object",
            "properties": {
                "hash": {
                    "type": "string"
        ...
        "main.OrdHookChain": {
            ...
            "properties": {
                ...
                "predicate": {
                    "$ref": "#/definitions/main.OrdHookPredicate"
                },
                "uuid": {
                    "type": "string"
                }
        ...
        "main.OrdHookEvent": {
            ...
            "properties": {
                "apply": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/main.OrdHookBlock"
                    }
                },
                "chainhook": {
                    "$ref": "#/definitions/main.OrdHookChain"
                },
                "rollback": {
        ...
        "main.OrdHookInscriptionRevealed": {
            "type": "object",
            "properties": {
                "content_bytes": {
                    "type": "string"
                ...
                "inscription_number": {
                    "$ref": "#/definitions/main.InscriptionNumber"
                },
        ...
        "main.OrdHookInscriptionTransferred": {
            "type": "object",
            "properties": {
                "destination": {
                    "$ref": "#/definitions/main.OrdHookDestination"
                },
                "inscription_id": {
                    "type": "string"
                },
        ...
        "main.OrdHookOrdinalOperation": {
            "type": "object",
            "properties": {
                "inscription_revealed": {
                    "$ref": "#/definitions/main.OrdHookInscriptionRevealed"
                },
                "inscription_transferred": {
                    "$ref": "#/definitions/main.OrdHookInscriptionTransferred"
                }
            }
        },
        "main.OrdHookPredicate": {
            "type": "object",
            "properties": {
                "operation": {
                    "type": "string"
        ...
        "main.OrdHookTransaction": {
            "type": "object",
            "properties": {
                "metadata": {
                    "$ref": "#/definitions/main.OrdHookTransactionMetadata"
                },
                "operations": {
                    "type": "array",
                    "items": {}
        ...
        "main.OrdHookTransactionMetadata": {
            "type": "object",
            "properties": {
                "ordinal_operations": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/main.OrdHookOrdinalOperation"
                    }
                },
                "proof": {}
            }
        },
        "main.ScanMissingBlocksResult": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "integer"
        ...
        "main.WebMrcAllInscriptionResult": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "integer"
